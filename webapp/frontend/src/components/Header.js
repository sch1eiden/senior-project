...
const Header = () => {
	...
	return (
		...
		>
			<ul
				class='col-sm-4 nav navbar-nav ml-0 justify-content-start'
				align='center'
			>
				<li class='nav-item'>
			...
			<ul
				class='col-sm-4 nav navbar-nav mr-0 justify-content-end'
				align='center'
			>
				<li class='nav-item'>
					<img
						src={require('./icon/en.jpg')}
