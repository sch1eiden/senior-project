                ...
                <div id="overlay-sensor" className="col-sm-6">
                    <Fade right>
                        <div className="card bg-light card-body">
                            ...
                            <p className="card-text">{t('ref')} <a className="card-text" href="https://en.wikipedia.org/wiki/Sensor">https://en.wikipedia.org/wiki/Sensor</a></p>
                        </div>
                    </Fade>
                </div>
                ...
                <div id="overlay-sensor1" className="col-sm-6">
                    <Fade right>
                        <div className="card bg-light card-body">
                            ...
                            <p className="card-text">{t('ref')} <a className="card-text" href="http://www.tic.co.th/index.php?op=tips-detail&id=291">http://www.tic.co.th/index.php?op=tips-detail&id=291</a></p>
                        </div>
                    </Fade>
                </div>
                <div id="overlay-sensor2" className="col-sm-6">
                    <Fade right>
                        <div className="card bg-light card-body">
                            ...
                            <p className="card-text">{t('ref')} <a className="card-text" href="https://www.ioxhop.com/product/402/mc-38-mc38-wired-door-window-sensor-magnetic-switch">https://www.ioxhop.com/product/402/mc-38-mc38-wired-door-window-sensor-magnetic-switch</a></p>
                        </div>
                    </Fade>
                </div>
